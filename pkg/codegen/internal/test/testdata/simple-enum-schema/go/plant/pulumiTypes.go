...
func (o ContainerOutput) Brightness() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v Container) *ContainerBrightness { return v.Brightness }).(pulumi.Float64PtrOutput)
}
...
func (o ContainerOutput) Size() pulumi.IntOutput {
	return o.ApplyT(func(v Container) ContainerSize { return v.Size }).(pulumi.IntOutput)
}
